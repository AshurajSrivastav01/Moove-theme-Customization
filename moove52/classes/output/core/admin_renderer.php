...
namespace theme_moove52\output\core;
...
class admin_renderer extends \core_admin_renderer {
    ...
    private function conectime_services_and_support_content(): string {
        return $this->render_from_template('theme_moove52/moove/conectime_services_and_support_content_banner', []);
    }
    ...
    private function conectime_partners_content(): string {
        return $this->render_from_template('theme_moove52/moove/conectime_partners_banner', []);
    }
}
