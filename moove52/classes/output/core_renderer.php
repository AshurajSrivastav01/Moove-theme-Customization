...
namespace theme_moove52\output;

use theme_config;
use core\context\course as context_course;
use moodle_url;
use html_writer;
use theme_moove52\output\core_course\activity_navigation;
use theme_moove52\util\settings;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    /**
     * This function to return the name of the current user
    */
    public function should_display_username() {
        global $USER, $PAGE;
        ...
        /**
     * This function to return the role of the current user
    */
    public function should_display_userrole() {
        global $USER, $PAGE;
        ...
        if (!empty($roles)) {
            $role = reset($roles); // grab the first role
            $rolename = role_get_name($role, $PAGE->context);
        }
    ...
    public function redirect_message(
        ...
        $output .= $this->render_from_template('theme_moove52/loading-overlay', ['encodedurl' => $encodedurl]);
    ...
    //     $newnav = new \theme_moove52\output\boostnavbar($this->page);
    ...
    //     // Convert the renderable into a template context.
    //     $context = (array) $newnav;
    ...
    public function navbar(): string {
        ...
        // Get the template context from boostnavbar.
        $context = $newnav->export_for_template($this);
    
        // Add extra values if required.
        // $context['sesskey'] = sesskey();
        $context['username'] = "Ashura";
        ...
        foreach ($roles as $role) {
            $context['roles'][] = [
                'name' => role_get_name($role, $systemcontext),
            ];
        }
    
        $context['config']['wwwroot'] = $CFG->wwwroot;
    ...
    public function render_mylearning_controls() {
        ...
        return $this->render_from_template('theme_moove52/moove/mylearning', []);
    }
    ...
    public function render_darkmode_controls() {
        ...
        return $this->render_from_template('theme_moove52/moove/darkmode', []);
    }
}
